...
void utilitiesy::slow_print(const std::string& str, int delay_time)
{
...
bool utilitiesy::ReadFileToMemory(const std::string& file_path, std::vector<uint8_t>* out_buffer)
{
...
bool utilitiesy::CreateFileFromMemory(const std::string& desired_file_path, const char* address, size_t size)
{
...
uint64_t utilitiesy::GetKernelModuleAddress(const std::string& module_name)
{
	void* buffer = nullptr;
	DWORD buffer_size = 0;
